...
import com.example.lenovo.myapplication.activity.find.NearPeopleActivity;
import com.example.lenovo.myapplication.activity.find.PiaoLiuPingActivity;
import com.example.lenovo.myapplication.activity.find.WebActivity;
import com.example.lenovo.myapplication.activity.find.YaoYiYaoActivity;
import com.example.lenovo.myapplication.activity.friend.FriendActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.shopping:
                ...
                String[] shoppingValue={"https://m.jd.com","京东购物"};
            ...
            case R.id.games:
                ...
                String[] gamesValue={"https://m.4399.cn","微信游戏"};
